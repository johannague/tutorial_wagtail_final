...
def detalle(url_cancion):
    url = urljoin ("https://www.elportaldemusica.es/" , url_cancion)
...
if __name__ == '__main__':
    ...
    canciones = pagina.xpath("//table[@data-caller-name='chart-top250movie']/tbody/tr")

    # test
    assert(len(canciones) == 250)

    datos = [datos_cancion(p) for p in canciones]
    json.dump(datos, open('datos_canciones_plus.json', 'w'))
